...
HX_LOCAL_STACK_FRAME(_hx_pos_176a1fae691a892a_588_print_function,"llua.Lua_helper","print_function",0x45befe61,"llua.Lua_helper.print_function","llua/Lua.hx",588,0x35651a49)
HX_LOCAL_STACK_FRAME(_hx_pos_176a1fae691a892a_596_register_hxtrace,"llua.Lua_helper","register_hxtrace",0x0bdf71d0,"llua.Lua_helper.register_hxtrace","llua/Lua.hx",596,0x35651a49)
HX_LOCAL_STACK_FRAME(_hx_pos_176a1fae691a892a_605___default_trace,"llua.Lua_helper","__default_trace",0xf1154c90,"llua.Lua_helper.__default_trace","llua/Lua.hx",605,0x35651a49)
HX_LOCAL_STACK_FRAME(_hx_pos_176a1fae691a892a_611_add_callback,"llua.Lua_helper","add_callback",0xe670c8da,"llua.Lua_helper.add_callback","llua/Lua.hx",611,0x35651a49)
HX_LOCAL_STACK_FRAME(_hx_pos_176a1fae691a892a_619_remove_callback,"llua.Lua_helper","remove_callback",0xf7602ac9,"llua.Lua_helper.remove_callback","llua/Lua.hx",619,0x35651a49)
HX_LOCAL_STACK_FRAME(_hx_pos_176a1fae691a892a_628_callback_handler,"llua.Lua_helper","callback_handler",0xc7862d87,"llua.Lua_helper.callback_handler","llua/Lua.hx",628,0x35651a49)
HX_LOCAL_STACK_FRAME(_hx_pos_176a1fae691a892a_609_boot,"llua.Lua_helper","boot",0x226c2b29,"llua.Lua_helper.boot","llua/Lua.hx",609,0x35651a49)
HX_LOCAL_STACK_FRAME(_hx_pos_176a1fae691a892a_627_boot,"llua.Lua_helper","boot",0x226c2b29,"llua.Lua_helper.boot","llua/Lua.hx",627,0x35651a49)
namespace llua{
...
int Lua_helper_obj::print_function(::String s){
            	HX_STACKFRAME(&_hx_pos_176a1fae691a892a_588_print_function)
HXLINE( 591)		::llua::Lua_helper_obj::trace(s,::hx::SourceInfo(HX_("llua/Lua.hx",49,1a,65,35),591,HX_("llua.Lua_helper",d7,1c,13,8b),HX_("print_function",aa,5c,49,10)));
HXLINE( 592)		return 0;
            	}
...
void Lua_helper_obj::register_hxtrace( cpp::Reference<lua_State> l){
            	HX_STACKFRAME(&_hx_pos_176a1fae691a892a_596_register_hxtrace)
HXLINE( 598)		linc::helpers::register_hxtrace_func(::cpp::Function< int (::String)>(::hx::AnyCast(&::llua::Lua_helper_obj::print_function )));
HXLINE( 599)		linc::helpers::register_hxtrace_lib(l);
            	}
...
void _hx_run(::String s, ::Dynamic inf){
            	HX_STACKFRAME(&_hx_pos_176a1fae691a892a_605___default_trace)
HXDLIN( 605)		::haxe::Log_obj::trace(s,::hx::SourceInfo(HX_("llua/Lua.hx",49,1a,65,35),605,HX_("llua.Lua_helper",d7,1c,13,8b),HX_("trace",85,8e,1f,16)));
            	}
...
bool Lua_helper_obj::add_callback( cpp::Reference<lua_State> l,::String fname, ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_176a1fae691a892a_611_add_callback)
HXLINE( 613)		::llua::Lua_helper_obj::callbacks->set(fname,f);
HXLINE( 614)		linc::callbacks::add_callback_function(l,fname);
...
bool Lua_helper_obj::remove_callback( cpp::Reference<lua_State> l,::String fname){
            	HX_STACKFRAME(&_hx_pos_176a1fae691a892a_619_remove_callback)
HXLINE( 621)		::llua::Lua_helper_obj::callbacks->remove(fname);
HXLINE( 622)		linc::callbacks::remove_callback_function(l,fname);
HXLINE( 623)		return true;
            	}
...
int Lua_helper_obj::callback_handler( cpp::Reference<lua_State> l,::String fname){
            	HX_STACKFRAME(&_hx_pos_176a1fae691a892a_628_callback_handler)
HXLINE( 629)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 631)			 ::Dynamic cbf = ::llua::Lua_helper_obj::callbacks->get(fname);
HXLINE( 633)			if (::hx::IsNull( cbf )) {
HXLINE( 633)				return 0;
            			}
HXLINE( 635)			int nparams = lua_gettop(l);
HXLINE( 636)			::cpp::VirtualArray args = ::cpp::VirtualArray_obj::__new(0);
HXLINE( 638)			{
HXLINE( 638)				int _g = 0;
HXDLIN( 638)				int _g1 = nparams;
HXDLIN( 638)				while((_g < _g1)){
HXLINE( 638)					_g = (_g + 1);
HXDLIN( 638)					int i = (_g - 1);
HXLINE( 639)					args->set(i,::llua::Convert_obj::fromLua(l,(i + 1)));
            				}
            			}
HXLINE( 642)			 ::Dynamic ret = null();
HXLINE( 645)			ret = ::Reflect_obj::callMethod(null(),cbf,args);
HXLINE( 647)			if (::hx::IsNotNull( ret )) {
HXLINE( 648)				::llua::Convert_obj::toLua(l,ret);
HXLINE( 649)				return 1;
            			}
            		} catch( ::Dynamic _hx_e) {
...
HXDLIN( 651)				 ::Dynamic e = _g2;
HXLINE( 652)				if (::llua::Lua_helper_obj::sendErrorsToLua) {
HXLINE( 652)					::String _hx_tmp;
HXDLIN( 652)					if (::hx::IsNotNull( e->__Field(HX_("message",c7,35,11,9a),::hx::paccDynamic) )) {
HXLINE( 652)						_hx_tmp = ( (::String)(e->__Field(HX_("message",c7,35,11,9a),::hx::paccDynamic)) );
            					}
            					else {
HXLINE( 652)						_hx_tmp = ( (::String)(e) );
            					}
HXDLIN( 652)					luaL_error(l,(HX_("CALLBACK ERROR! ",2c,95,4f,d2) + _hx_tmp),::cpp::VirtualArray_obj::__new(0));
HXDLIN( 652)					return 0;
            				}
HXLINE( 653)				::haxe::Log_obj::trace(e,::hx::SourceInfo(HX_("llua/Lua.hx",49,1a,65,35),653,HX_("llua.Lua_helper",d7,1c,13,8b),HX_("callback_handler",10,70,1b,10)));
HXLINE( 654)				HX_STACK_DO_THROW(e);
            			}
            			else {
...
{
            	HX_GC_STACKFRAME(&_hx_pos_176a1fae691a892a_609_boot)
HXDLIN( 609)		callbacks =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            	}
{
            	HX_STACKFRAME(&_hx_pos_176a1fae691a892a_627_boot)
HXDLIN( 627)		sendErrorsToLua = true;
            	}
}
