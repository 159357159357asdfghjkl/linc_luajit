...
HX_DEFINE_STACK_FRAME(_hx_pos_3631b16da1c6e72f_59_new,"haxe.ds.ObjectMap","new",0x27af5498,"haxe.ds.ObjectMap.new","F:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/ObjectMap.hx",59,0x984ff8e1)
HX_LOCAL_STACK_FRAME(_hx_pos_3631b16da1c6e72f_66_get,"haxe.ds.ObjectMap","get",0x27aa04ce,"haxe.ds.ObjectMap.get","F:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/ObjectMap.hx",66,0x984ff8e1)
HX_LOCAL_STACK_FRAME(_hx_pos_3631b16da1c6e72f_77_keys,"haxe.ds.ObjectMap","keys",0x8fbf0ebc,"haxe.ds.ObjectMap.keys","F:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/ObjectMap.hx",77,0x984ff8e1)
namespace haxe{
namespace ds{

void ObjectMap_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_3631b16da1c6e72f_59_new)
            	}
...
void *ObjectMap_obj::_hx_getInterface(int inHash) {
 ...
 ::Dynamic ObjectMap_obj::get( ::Dynamic key){
            	HX_STACKFRAME(&_hx_pos_3631b16da1c6e72f_66_get)
...
HX_DEFINE_DYNAMIC_FUNC1(ObjectMap_obj,get,return )
 ...
 ::Dynamic ObjectMap_obj::keys(){
            	HX_GC_STACKFRAME(&_hx_pos_3631b16da1c6e72f_77_keys)
