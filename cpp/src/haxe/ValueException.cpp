...
HX_DEFINE_STACK_FRAME(_hx_pos_66f9d7fd7924a133_23_new,"haxe.ValueException","new",0xb19045f8,"haxe.ValueException.new","F:\\HaxeToolkit\\haxe\\std/haxe/ValueException.hx",23,0x664be40d)
namespace haxe{

void ValueException_obj::__construct( ::Dynamic value, ::haxe::Exception previous, ::Dynamic native){
            	HX_STACKFRAME(&_hx_pos_66f9d7fd7924a133_23_new)
